"""
Udacity Self-Driving Car Nanodegree, Term 1, Project 3: Behavioral Cloning

Uses a Convolutional Neural Network to mimic driving habits learned from test data to drive a car simulator 
automonously around a track.
BH 4/23/2018
"""
...
Most of this code was taken from lecture
'''
#Various data paths
data_path = './data'
...
"""
Architecture used was adapted into Keras from: 
...
# Normalize (-0.5 to 0.5) and Crop images
...
This code was also taken from lecture
"""
